...
// [SECTION] Example App: Property Editor / ShowExampleAppProperties()
...
static void ShowExampleAppProperties(bool *p_open);
...
void ImGui::ShowDemoWindow(bool *p_open)
{
    ...
    if (show_app_property_editor)
        ShowExampleAppProperties(&show_app_property_editor);
